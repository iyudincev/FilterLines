...
#ifndef __FAR_SETTINGS_H__
#define __FAR_SETTINGS_H__
...
class CFarSettings
{
  ...
  public:
    ...
    void Set(const wchar_t* aName,const void* aValue,size_t aSize);
    __int64 Get(const wchar_t* aName,__int64 aDefault=0);
    bool Get(const wchar_t* aName,bool aDefault);
    bool Get(const wchar_t* aName,wchar_t* aValue,size_t aSize);
    size_t Get(const wchar_t* aName,void* aValue,size_t aSize);
};
